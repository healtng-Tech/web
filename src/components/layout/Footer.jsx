    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          {/* Columna 1: Marca, Misión sin Jergas y Redes Robustas */}
          <div className="md:col-span-1 lg:col-span-2">
            ...
            {/* Redes Sociales Sólidas (SimpleIcons oficiales) */}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li><a href="#soluciones" onClick={(e) => handleScroll(e, 'soluciones')} className="text-[14px] text-slate-500 hover:text-[#002EE5] font-medium transition-colors">Para profesionales</a></li>
              <li><a href="#soluciones" onClick={(e) => handleScroll(e, 'soluciones')} className="text-[14px] text-slate-500 hover:text-[#002EE5] font-medium transition-colors">Para farmacias</a></li>
              <li><a href="#infraestructura" onClick={(e) => handleScroll(e, 'infraestructura')} className="text-[14px] text-slate-500 hover:text-[#002EE5] font-medium transition-colors">Para centros de atención</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li><a href="#inicio" onClick={(e) => handleScroll(e, 'inicio')} className="text-[14px] text-slate-500 hover:text-[#002EE5] font-medium transition-colors">Sobre nosotros</a></li>
